...
Ticker: GC=F (gold futures), via yfinance.
"""
...
def fetch_intraday(interval: str = '5m',
    ...
    """
    Fetch 5-minute XAU/USD bars for last 48 hours.
    ...
    # Recent yfinance returns MultiIndex columns (Price, Ticker) even for a
    # single ticker; flatten to the OHLCV level so df['High'] is a Series.
